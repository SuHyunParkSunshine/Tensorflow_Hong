...
out3 = tf.keras.layers.Concatenate()([x, y])    # x, y를 그냥 그대로 붙여주는 것
out4 = tf.keras.layers.Dot(axes=[1,1])([x, y])  # inner product(내적연산)
out5 = tf.keras.layers.Dot(axes=1)([x, y])      # outer product(외적연산)
